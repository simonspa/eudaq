...
find_path(PXAR_RPC_INCLUDE_DIR rpc_error.h
  HINTS "${PXARPATH}/core/rpc" "$ENV{PXARPATH}/core/rpc")

find_library(PXARCORE_LIBRARY NAMES pxar
  HINTS "${PXARPATH}/lib" "$ENV{PXARPATH}/lib")

set(PXARCORE_LIBRARIES ${PXARCORE_LIBRARY} )
set(PXARCORE_INCLUDE_DIRS ${PXARCORE_API_INCLUDE_DIR} ${PXARCORE_UTILS_INCLUDE_DIR} ${PXARCORE_DECODER_INCLUDE_DIR} ${PXAR_UTIL_INCLUDE_DIR} ${PXAR_RPC_INCLUDE_DIR})
